...
public class DownloadApkManager {
     ...
     * @return
     */
    public DownLoadBean query(Context context, long downId) {
        ...
        if (cursor == null) {
            ...
            cursor.close();
            DownLoadBean downInfo = new DownLoadBean(downId, localUrl, url, compeleteSize, totalSize, status);
            return downInfo;
        } else {
            cursor.close();
        }
...
//        request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI);
        ...
        request.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, "VCashWallet.apk");
        //第二种
...
//        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "update.apk");
     ...
     * @param downloadId
     */
    public void removeTask(Context context,long downloadId){
        DownloadManager downloadManager = (DownloadManager) context.getSystemService(Context.DOWNLOAD_SERVICE);
        if(downloadManager != null){
