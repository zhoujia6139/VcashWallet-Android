...
public class VcashSendDialog extends DialogFragment {
    ...
    public static VcashSendDialog newInstance(Bundle args){
        VcashSendDialog fragment = new VcashSendDialog();
        if(args != null){
    ...
    public VcashSendDialog setOnConfirmClickListener(OnConfirmClickListener listener){
        mListener = listener;
        return this;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_send_dialog, container);
    }
