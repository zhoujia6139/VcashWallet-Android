...
import com.vcashorg.vcashwallet.widget.qrcode.adapter.PickPictureTotalAdapter;
 ...
 * 2018/6/7.
 */
public class PickPictureTotalActivity extends ToolBarActivity {
    ...
    private void getPicture() {
        //显示进度条
        mProgressDialog = ProgressDialog.show(this, null, "wait");
