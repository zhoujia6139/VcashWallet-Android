...
public class WalletMain3Activity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_drawer_3;
    }
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if(entity.getItemType() == WalletTxEntity.TYPE_SERVER_TX){
                    ...
                    Intent intent = new Intent(WalletMain3Activity.this, TxDetailsActivity.class);
    ...
    public void showNewTxPop() {
        ...
        if (recentTx != null) {
            popUtil = PopUtil.get(WalletMain3Activity.this,recentTx).setConfirmListener(new PopUtil.PopOnCall() {
                @Override
